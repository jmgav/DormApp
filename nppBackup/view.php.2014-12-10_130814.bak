...
<div class="col-sm-7">
		<div class="radio">
      <label>
        <input type="radio" name="bracket" value="A" <?php echo $bracket=='A'? "checked" : ""; ?>>
         A
      </label>
    </div>
	<div class="radio">
      <label>
        <input type="radio" name="bracket" value="B" <?php echo $bracket=='B'? "checked" : ""; ?>>
        B
      </label>
    </div>
	<div class="radio">
      <label>
        <input type="radio" name="bracket" value="C" <?php echo $bracket=='C'? "checked" : ""; ?>>
        C
      </label>
    </div>
	<div class="radio">
      <label>
        <input type="radio" name="bracket" value="D" <?php echo $bracket=='D'? "checked" : ""; ?>>
       D
      </label>
    </div>
	<div class="radio">
      <label>
        <input type="radio" name="bracket" value="E" <?php echo $bracket=='E'? "checked" : ""; ?>>
      E1/E2
      </label>
	  </div>
    </div>
...
<div class="col-sm-7">
	...
	<div class="radio">
      <label>
        <input type="radio" name="income" value="500001" <?php echo $income==500001? "checked" : ""; ?>>
        500,001-1,000,000
      </label>
    </div>
	<div class="radio">
      <label>
        <input type="radio" name="income" value="1000000" <?php echo $income==1000000? "checked" : ""; ?>>
      Above 1 million
      </label>
	  </div>
    </div>
