...
<div class="alert alert-info fade in" data-alert="alert">
 ...
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Units to be Enrolled</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Landline no. (with area code)</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 ...
 <div class="form-group">
   ...
   <div class="col-md-6">
    <div class="panel panel-info">
    <div class="panel-heading">B. Parents' Information</div>
    <div class="panel-body">
      <form role="form">
  <div class="form-group">
	<div class="input-group">
 ...
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Mothers' Address</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Mothers' Occupation</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Mothers' Landline no.</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Mothers' Mobile no.</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
 ...
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Fathers' Address</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Fathers' Occupation</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Fathers' Landline no.</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Fathers' Mobile no.</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 ...
 <div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Relationship with Applicant</span>
		<input class="form-control" placeholder="">
	</div>
</div>
 <div class="form-group">
...
<div class="form-group">
<label class="col-sm-4 control-label" for="scholarship">Name of Scholarship</label>
<div class="col-sm-8"><input class="form-control" id="scholarship" placeholder="(leave blank if none)" /></div>
</div>

 <div class="form-group">

<label class="col-sm-4 control-label" for="scholarship">Coverage</label>
<div class="col-sm-8">
		<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox1" value="tuition">
         Tuition and miscellaneous
      </label>
    </div>
	<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox2" value="accomodation">
        Accommodation
      </label>
    </div>
	<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox3" value="food">
        Food
      </label>
    </div>
	<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox4" value="transpo">
        Transportation
      </label>
    </div>
	<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox5" value="books">
       Books
      </label>
	  </div>
    </div>
...
<label class="col-sm-4 control-label" for="scholarship">Assigned STFAP bracket</label>
<div class="col-sm-8">
		<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox1" value="tuition">
...
<label class="col-sm-4 control-label" for="scholarship">Annual Family income</label>
<div class="col-sm-8">
		<div class="checkbox">
      <label>
        <input type="checkbox" name="optionsRadios" id="optionsCheckbox1" value="tuition">
